...
- Zhaolin Wang: Wrote project introduction, performed EDA on disaster trends, Produced disaster geographical disstribution heat map, produced disaster time distribution bar chart, Wrote deep analyses for graphs produced, Designed entire ui structure and put everyone’s code together to built shiny app server, Deployed both locally on R and on the internet, revised & finalized main R file.
